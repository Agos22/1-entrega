...
public class Modelo {
    ...
    public static void main(String[] args) throws SQLException, ClassNotFoundException {
        ...
        try {
            ...
            String sql1= " INSERT INTO alumno(id, nombre, apellido, edad, activo) "
                   + "VALUES (2, 'Joanna', 'Guitierrez', 22, 2)";
            
            PreparedStatement psa=conn.prepareStatement(sql1);
            int fila = psa.executeUpdate();
